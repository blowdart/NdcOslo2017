...
using IndividualAuth.Identity.Data;
using IndividualAuth.Identity.Models;
using IndividualAuth.Identity.Services;

// HostingStartup's in the primary assembly are run automatically.
[assembly: HostingStartup(typeof(IndividualAuth.Identity.IdentityServiceStartup))]

namespace IndividualAuth.Identity
{
